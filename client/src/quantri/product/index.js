...
export default function SimpleTable(props) {
  ...
  productsToShow = productsToShow.slice(
    tranghientai * sobaiviet1trang - sobaiviet1trang,
    tranghientai * sobaiviet1trang
  );
  ...
  return (
    <div>
      <div style={{ padding: "10px", background: "#3f51b5", color: "#FFFFFF" }}>
        Danh sách sản phẩm
      </div>
      {productsToShow.length > 0 ? (
              ...
              {productsToShow.map((product, key) => (
                <TableRow key={key}>
                  ...
                  <TableCell align="left">
                    <img alt="img" src={product.img[0]} height="100px" />
                  </TableCell>
                  <TableCell align="left">
        ...
        <div>
          <Alert content={"Không tìm thấy sản phẩm!"} />
        </div>
      )}
      <div>
